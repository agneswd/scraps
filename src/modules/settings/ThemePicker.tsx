...
const OPTIONS: Array<{ id: ThemePreference; labelKey: string }> = [
      ...
      {OPTIONS.map((option) => {
        ...
        return (
          ...
          >
            ...
            <span className={['h-2.5 w-2.5 rounded-full transition-colors', isActive ? 'bg-white/70 dark:bg-slate-900/70' : 'bg-slate-300 dark:bg-slate-600'].join(' ')} />
          </button>
        );
      })}
    </div>
